    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input name="project_name" class="form-control" type="text" id="example-text-input">
            ...
            <!-- end row -->
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input name="task_name" class="form-control" type="text" id="example-text-input">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input name="start_date" class="form-control" type="date" value="" id="example-date-input">
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input name="end_date" class="form-control" type="date" value="" id="example-date-input">
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                <textarea id="elm1" name="task_description">
